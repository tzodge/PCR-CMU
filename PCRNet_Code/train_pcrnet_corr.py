...
class CorrLoss(torch.nn.Module):
    def forward(self, target, src, corr_mat_pred, corr_mat):
...
def test(args, net, test_loader, boardio, textio):
    ...
    test_translations_ba_pred, test_eulers_ab, test_eulers_ba, test_corr_accuracy = test_one_epoch(args, net, test_loader)
...
def train(args, net, train_loader, test_loader, boardio, textio):
    ...
    for epoch in range(args.epochs):
        ...
        train_translations_ba_pred, train_eulers_ab, train_eulers_ba, train_corr_accuracy = train_one_epoch(args, net, train_loader, opt)
        test_loss, test_cycle_loss, \
        test_mse_ab, test_mae_ab, test_mse_ba, test_mae_ba, test_rotations_ab, test_translations_ab, \
        test_rotations_ab_pred, \
        test_translations_ab_pred, test_rotations_ba, test_translations_ba, test_rotations_ba_pred, \
